...
author: jace
title: "Are Seed Oils Bad for You? Ask How They're Made, Not What One Blood Marker Did"
excerpt: We don't cook with seed oils, and the reason has nothing to do with inflammation. Getting oil out of a seed takes solvent extraction, bleaching and steam-stripping at 200°C. Getting oil out of an olive takes a press. No trial in this debate ever tested that difference.
tags: [big-food, seed-oils, ultra-processed, refining, research]
seoTitle: "Are Seed Oils Bad for You? What the Studies Never Asked"
seoDescription: Seed oil trials measure one blood marker over a few weeks. None of them tested the refining chain, the bottle on the shelf, or the fryer running since Tuesday.
seoKeywords: [are seed oils bad for you, how is canola oil made, hexane extraction seed oils, seed oils vs olive oil, refined vegetable oil]
---
...
```stats
[{"value": 9, "label": "Distinct industrial stages to turn rapeseed into commodity canola oil, from flaking to deodorizing", "source": "Standard oilseed refining process"}, {"value": 200, "suffix": "°C", "label": "Approximate deodorizing temperature in commodity oil refining", "source": "Standard oilseed refining process"}, {"value": 53.0, "suffix": "%", "decimals": 1, "label": "Share of US adult calories from ultra-processed food — where most seed oil is actually eaten", "source": "CDC/NCHS Data Brief 536, 2025"}, {"value": 0, "label": "Trials in this literature that isolated the effect of the refining chain itself", "source": "Our review of the cited evidence"}]
```
...
- Traditional rapeseed ran **40% or more erucic acid**, linked to heart damage in animal studies; canola is the cultivar bred to remove it, released in 1974. The name is an abbreviation: **Can**ada, **O**il, **L**ow **A**cid — *Stefansson & Downey, University of Manitoba*
...
```chart
{"type": "hbar", "title": "Industrial stages required to produce one bottle of fat", "suffix": " stages", "source": "Standard production processes. Olive and coconut oil are mechanically pressed; butter is churned cream; commodity seed oil requires solvent extraction and multi-stage refining because crude pressed seed oil is not palatable.", "data": [{"label": "Butter (churned cream)", "value": 1, "tone": "good"}, {"label": "Extra-virgin olive oil", "value": 2, "tone": "good"}, {"label": "Virgin coconut oil", "value": 2, "tone": "good"}, {"label": "Commodity canola / soybean oil", "value": 9, "tone": "bad"}]}
```
...
**The specific claim that omega-6 linoleic acid drives inflammation is not supported by the controlled evidence**, and we are not going to repeat it. A systematic review of randomized trials in healthy people found no causal relationship between linoleic acid intake and inflammatory markers ([Johnson & Fritsche, 2012](https://pubmed.ncbi.nlm.nih.gov/22889633/)). A 2017 meta-analysis pooling 30 randomized studies found no significant effect on IL-6 or CRP. Researchers went looking for the mechanism and it did not appear in people.
...
- [FDA — Final Determination Regarding Partially Hydrogenated Oils (2015)](https://www.federalregister.gov/documents/2015/06/17/2015-14883/final-determination-regarding-partially-hydrogenated-oils)
