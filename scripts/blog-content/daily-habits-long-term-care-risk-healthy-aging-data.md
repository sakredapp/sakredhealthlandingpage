...
seoTitle: "What Sends People Into Long-Term Care: The Data"
seoDescription: "Verified data on what actually triggers long-term care — falls, frailty, cognitive decline — which habits shift the odds, and where the evidence stops."
seoKeywords: [reduce long-term care risk, healthy aging habits, how to avoid a nursing home, what causes loss of independence in old age, fall prevention older adults]
---
...
```stats
[{"value": 26.2, "suffix": "M", "decimals": 1, "label": "U.S. adults 65+ living with an activity limitation in 2022, up from 18.4M in 2011", "source": "Health Affairs (Freedman et al.), 2026"}, {"value": 23, "suffix": "%", "label": "Reduction in fall rate from exercise programs in older adults", "source": "Cochrane Review, 2019"}, {"value": 45, "suffix": "%", "label": "Share of dementia cases attributable to 14 modifiable risk factors, population-wide", "source": "Lancet standing Commission, 2024"}, {"value": 13.9, "suffix": "%", "decimals": 1, "label": "Adults 65+ meeting both aerobic and muscle-strengthening guidelines, 2022", "source": "CDC/NCHS, 2024"}]
```
...
```chart
{"type": "hbar", "title": "Reduction in fall rate by exercise type (Cochrane, 108 RCTs, 23,407 participants)", "suffix": "%", "source": "Sherrington et al., Cochrane Database of Systematic Reviews, 2019", "height": 260, "data": [{"label": "Multiple exercise types combined", "value": 34}, {"label": "Balance & functional training", "value": 24}, {"label": "Exercise overall", "value": 23}, {"label": "Tai Chi", "value": 19}]}
```
...
The costs on the other side of that door do not scale with effort. Per CareScout's 2025 Cost of Care Survey, the median private nursing home room runs $129,575 a year, assisted living $74,400, and an in-home caregiver at 44 hours a week $80,080 — on top of the [ordinary medical costs of retirement](/blog/healthcare-costs-retirement-medical-debt-statistics). No routine cancels that invoice.

So the honest framing is two-part, and we'll say it plainly as a company that sells the second part: **habits shift the probability; coverage handles the tail.** Balance training is the highest-leverage thing you can do about a 24% relative risk reduction. It does nothing for the 22% who need five-plus years of help. Guaranteed lifetime income through [retirement annuities](/products/retirement-annuities) can fund a care bill without forcing asset sales in a bad market; a small [final expense policy](/products/final-expense) keeps the last obligation off your children regardless. To price what covering the tail looks like, you can [start a coverage conversation](/get-coverage) in a few minutes.

## A routine that matches the evidence

Consistency over intensity. Based on what actually showed effects above:

1. **Balance and functional training, 2–3 sessions a week.** Highest-evidence intervention in the review (24%). Single-leg stands, tandem walking, sit-to-stands, step-ups. No equipment, ten minutes.
2. **Resistance training, 2 days a week, all major muscle groups.** A 2020 *Sports Medicine* meta-analysis found large strength gains in adults over 75, with significant effects persisting past 80.
3. **Enough protein.** The PROT-AGE Study Group's 2013 position paper in *JAMDA* recommends 1.0–1.2 g per kg of body weight daily for healthy older adults, above the standard RDA, and 1.2–1.5 g/kg with illness.
4. **Seven hours of sleep, defended.** Our [14-day sleep and nervous system reset protocol](/blog/sleep-nervous-system-reset-14-day-protocol) covers the mechanism-first version; the [science of nightly routines](/blog/science-of-sleep-nightly-routines-better-rest-focus) covers fundamentals.
5. **Treat hearing and vision as brain care, and schedule social contact like an appointment.** All three are on the Lancet Commission's list; standing commitments beat good intentions.
6. **Break up sedentary time daily.** Inactivity is upstream of nearly everything here; a [lymphatic drainage and movement routine](/blog/lymphatic-drainage-routine-21-day-guide) is an easy on-ramp for people who find "exercise" intimidating.

Fatigue, stiffness, and slower stairs are signals, not flaws — and the earliest, cheapest place to intervene. [The Sakred app](/app) runs these as scheduled daily protocols with streaks, reminders, and paired guides, in Lite (15–20 minutes) and Intensive (45–60 minutes) versions, so the routine survives the weeks you don't feel like it. That is the whole trick: not intensity, but the thing you still do in year three.
...
- [Health Affairs (Freedman, Patterson, Cornman, Wolff) — Trends In Care Needs Among Older US Adults Diverged By Age, 2011–22 (2026)](https://www.healthaffairs.org/doi/10.1377/hlthaff.2025.01355)
- [CDC — Facts About Falls, Older Adult Fall Prevention (2026)](https://www.cdc.gov/falls/data-research/facts-stats/index.html)
- [CDC/NCHS (Garnett, Weeks, Zehner) — Unintentional Fall Deaths in Adults Age 65 and Older: United States, 2023, Data Brief No. 532 (2025)](https://www.cdc.gov/nchs/products/databriefs/db532.htm)
- [National Council on Aging — Get the Facts on Falls Prevention (2025)](https://www.ncoa.org/article/get-the-facts-on-falls-prevention/)
- [Journal of Clinical Medicine (Ito et al.) — Time to Death and Nursing Home Admission in Older Adults with Hip Fracture (2025)](https://pmc.ncbi.nlm.nih.gov/articles/PMC12693230/)
- [Frontiers in Physiology (Mitchell et al.) — Sarcopenia, Dynapenia, and the Impact of Advancing Age on Human Skeletal Muscle Size and Strength (2012)](https://pmc.ncbi.nlm.nih.gov/articles/PMC3429036/)
- [The Lancet (Leong et al.) — Prognostic Value of Grip Strength: Findings from the PURE Study (2015)](https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(14)62000-6/abstract)
- [CDC/NCHS (Elgaddal & Kramarow) — Physical Activity Among Adults Aged 18 and Over, National Health Statistics Reports No. 215 (2024)](https://www.cdc.gov/nchs/data/nhsr/nhsr215.pdf)
- [Cochrane Database of Systematic Reviews (Sherrington et al.) — Exercise for Preventing Falls in Older People Living in the Community (2019)](https://www.cochranelibrary.com/cdsr/doi/10.1002/14651858.CD012424.pub2/full)
- [JAMA (Pahor et al.) — Effect of Structured Physical Activity on Prevention of Major Mobility Disability in Older Adults: The LIFE Study (2014)](https://jamanetwork.com/journals/jama/fullarticle/1875328)
- [New England Journal of Medicine (Bhasin et al.) — A Randomized Trial of a Multifactorial Strategy to Prevent Serious Fall Injuries, STRIDE (2020)](https://www.nejm.org/doi/full/10.1056/NEJMoa2002183)
- [Sports Medicine — Effects of Resistance Training on Muscle Size and Strength in Very Elderly Adults: A Systematic Review and Meta-Analysis of RCTs (2020)](https://link.springer.com/article/10.1007/s40279-020-01331-7)
- [JAMDA (Bauer et al.) — Evidence-Based Recommendations for Optimal Dietary Protein Intake in Older People: PROT-AGE Study Group (2013)](https://www.jamda.com/article/s1525-8610(13)00326-5/fulltext)
- [The Lancet (Livingston et al.) — Dementia Prevention, Intervention, and Care: 2024 Report of the Lancet Standing Commission (2024)](https://www.thelancet.com/article/S0140-6736(24)01296-0/abstract)
- [JAMA (Baker et al.) — Structured vs Self-Guided Multidomain Lifestyle Interventions for Global Cognitive Function: The US POINTER Randomized Clinical Trial (2025)](https://jamanetwork.com/journals/jama/fullarticle/2837046)
- [The Lancet (Lin et al.) — Hearing Intervention Versus Health Education Control to Reduce Cognitive Decline: The ACHIEVE Trial (2023)](https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(23)01406-X/abstract)
- [Nature Communications (Sabia et al.) — Association of Sleep Duration in Middle and Old Age with Incidence of Dementia (2021)](https://www.nature.com/articles/s41467-021-22354-2)
- [Nature Mental Health (Luchetti et al.) — A Meta-Analysis of Loneliness and Risk of Dementia Using Longitudinal Data from >600,000 Individuals (2024)](https://www.nature.com/articles/s44220-024-00328-9)
- [Alzheimer's Association — 2026 Alzheimer's Disease Facts and Figures (2026)](https://www.alz.org/alzheimers-dementia/facts-figures)
- [HHS ASPE — Long-Term Services and Supports for Older Americans: Risks and Financing (2022)](https://aspe.hhs.gov/sites/default/files/documents/08b8b7825f7bc12d2c79261fd7641c88/ltss-risks-financing-2022.pdf)
- [CareScout/Genworth — Cost of Care Survey 2025: Median Cost Data Tables (2026)](https://assets.carescout.com/x/8fcb50422f/282102.pdf)
</content>
