---
featuredImage: https://images.unsplash.com/photo-1704398811049-cf09880810ee?w=1200&h=630&fit=crop&auto=format&q=80
featuredImageAlt: A dark bedroom with light through the window
author: gerard
...
seoTitle: "The Science of Sleep: Nightly Routines That Work"
seoDescription: "What the data says about better sleep: CDC 2024 stats, the sleep-regularity mortality study, and Oura and WHOOP member data on light, caffeine, and alcohol."
seoKeywords: [science of sleep, nightly routine, sleep regularity, sleep hygiene, circadian rhythm]
---
...
Two things follow. First, the fix isn't only "night mode" — it's dimming the whole room, because total light intensity matters alongside wavelength. Second, four hours of pre-bed screens is an extreme dose, but it establishes the direction of the effect. A realistic target: cut bright screens 60 to 90 minutes before bed and drop household lighting to lamp level. If evening screen time is the hardest part of your routine to move, our guide to [reducing screen fatigue](/blog/digital-overload-daily-habits-reduce-screen-fatigue-boost-focus) covers the habit side of it.
...
1. **Fix your wake time first.** Pick one, apply it seven days a week including weekends, and let bedtime settle. Regularity was the strongest predictor in the UK Biobank data, and wake time is the easier end to control.
2. **Last caffeine 8–10 hours before bed.** For a 10:30 p.m. bedtime, that's roughly 12:30 to 2:30 p.m.
3. **Warm shower or bath, 10 minutes, 1–2 hours before bed.** A 2019 *Sleep Medicine Reviews* meta-analysis by Haghayegh and colleagues (17 qualifying studies) found that water-based passive body heating at 104–108.5°F, timed one to two hours before bed, shortened time to fall asleep by **about 10 minutes** and improved sleep efficiency.
4. **Bright screens off 60–90 minutes out; room lights down with them.**
5. **Set the bedroom cool and test it.** Start in the high 60s to low 70s °F and adjust based on how you actually sleep, not on a number you read.
6. **Skip the nightcap on nights that matter.** If tomorrow requires focus, the Oura numbers above are the tradeoff you're accepting.
7. **Get outside within an hour of waking.** Morning light anchors the circadian phase everything else here depends on, and it's free.
...
- [CDC / National Center for Health Statistics — Short Sleep Duration and Sleep Difficulties Among Adults: United States, 2024 (2026)](https://www.cdc.gov/nchs/products/databriefs/db559.htm)
- [RAND Corporation — Lack of Sleep Costing U.S. Economy Up to $411 Billion a Year (2016)](https://www.rand.org/news/press/2016/11/30.html)
- [American Academy of Sleep Medicine — Seven or More Hours of Sleep Per Night: A Health Necessity for Adults (2015)](https://aasm.org/seven-or-more-hours-of-sleep-per-night-a-health-necessity-for-adults/)
- [SLEEP (Oxford Academic) — Windred et al., Sleep Regularity Is a Stronger Predictor of Mortality Risk Than Sleep Duration (2023)](https://academic.oup.com/sleep/article/47/1/zsad253/7280269)
- [Oura — How Do Oura Members' Sleep Patterns and Heart Health Metrics Change with Age? (2025)](https://ouraring.com/blog/data-story-sleep-and-heart-health/)
- [Oura — How Alcohol Impacts Sleep: Debunking the Myth of the Nightcap (2025)](https://ouraring.com/blog/how-drinking-impacts-sleep/)
- [Athletech News — Women Get More Sleep Than Men, but They're More Stressed, Too: Oura 2025 Year in Review (2025)](https://athletechnews.com/women-sleep-more-than-men-but-more-stressed-oura-report/)
- [WHOOP — Sleep Consistency: Benefits and How WHOOP Measures It](https://www.whoop.com/us/en/thelocker/sleep-consistency-more-to-sleep-than-sleep-need/)
- [PNAS — Chang et al., Evening Use of Light-Emitting eReaders Negatively Affects Sleep, Circadian Timing, and Next-Morning Alertness (2015)](https://www.pnas.org/doi/10.1073/pnas.1418490112)
- [Science of the Total Environment — Baniassadi et al., Nighttime Ambient Temperature and Sleep in Community-Dwelling Older Adults (2023)](https://pubmed.ncbi.nlm.nih.gov/37474050/)
- [Hebrew SeniorLife / Marcus Institute for Aging Research — Optimal Sleep Temperature for Seniors Is Between 68 to 77 Degrees Fahrenheit (2023)](https://www.marcusinstituteforaging.org/news/optimal-sleep-temperature-seniors-between-68-77-degrees-fahrenheit-study-reveals)
- [Journal of Clinical Sleep Medicine — Drake et al., Caffeine Effects on Sleep Taken 0, 3, or 6 Hours Before Going to Bed (2013)](https://jcsm.aasm.org/doi/abs/10.5664/jcsm.3170)
- [NCBI Bookshelf — Pharmacology of Caffeine, in Caffeine for the Sustainment of Mental Task Performance (2001)](https://www.ncbi.nlm.nih.gov/books/NBK223808/)
- [Sleep Medicine Reviews — Haghayegh et al., Before-Bedtime Passive Body Heating by Warm Shower or Bath to Improve Sleep (2019)](https://www.sciencedirect.com/science/article/abs/pii/S1087079218301552)
- [Occupational and Environmental Medicine — Williamson & Feyer, Moderate Sleep Deprivation Produces Impairments in Cognitive and Motor Performance Equivalent to Legally Prescribed Levels of Alcohol Intoxication (2000)](https://pubmed.ncbi.nlm.nih.gov/10984335/)
- [AAA Foundation for Traffic Safety — Drowsy Driving in Fatal Crashes, United States, 2017–2021 (2024)](https://aaafoundation.org/drowsy-driving-in-fatal-crashes-united-states-2017-2021/)
