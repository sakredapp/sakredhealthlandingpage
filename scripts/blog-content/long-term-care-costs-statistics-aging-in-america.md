...
```stats
[{"value": 129575, "prefix": "$", "label": "Median yearly cost of a private nursing home room in 2025", "source": "CareScout Cost of Care Survey, 2025"}, {"value": 70, "suffix": "%", "label": "Adults surviving to 65 who develop severe long-term care needs", "source": "HHS ASPE / Urban Institute"}, {"value": 0, "suffix": " days", "label": "Ongoing custodial care covered by Medicare", "source": "KFF, 2024"}, {"value": 1.01, "prefix": "$", "suffix": "T", "decimals": 2, "label": "Economic value of unpaid family caregiving in 2024", "source": "AARP Valuing the Invaluable, 2026"}]
```
...
```chart
{"type": "hbar", "title": "Median annual long-term care cost by setting, 2025", "prefix": "$", "source": "CareScout/Genworth Cost of Care Survey, 2025", "height": 300, "data": [{"label": "Nursing home, private room", "value": 129575}, {"label": "Nursing home, semi-private", "value": 114975}, {"label": "In-home caregiver (44 hrs/wk)", "value": 80080}, {"label": "Assisted living", "value": 74400}, {"label": "Adult day health care", "value": 24700}]}
```

| Care setting | Typical rate | Median annual cost | Change vs. 2024 |
|---|---|---|---|
...
| Care setting | Least expensive state | Most expensive state |
|---|---|---|
| Nursing home, semi-private room | Texas — $67,525/yr | Alaska — $333,975/yr |
| Nursing home, private room | Texas & Missouri — $91,250/yr | Oregon — $221,373/yr |
| Assisted living | Mississippi — $52,425/yr | Hawaii — $145,155/yr |
| In-home caregiver (hourly) | Mississippi — $24/hr | Wyoming — $46/hr |
...
3. **Build a care income floor.** Guaranteed lifetime income can fund an $80,000/year home-care bill without forcing asset sales in a down market — this is one of the core use cases for [retirement annuities](/products/retirement-annuities).
4. **Ring-fence final expenses separately.** Long-term care routinely drains the savings families assumed would cover a funeral (a single year in a semi-private nursing home room now runs $114,975). A small [final expense policy](/products/final-expense) keeps that obligation off your children's credit cards no matter what care ends up costing.
...
Every figure in this article points the same direction: the risk is common (70% lifetime), the cost is high ($74,400–$129,575 a year), the default payer is your own savings until Medicaid, and the fallback is 49.5 billion hours of unpaid family labor. None of that is a reason for despair — it is a reason to run the numbers at 55 instead of 75, while insurance, income products, and housing choices are all still on the table. If you want help stress-testing your own plan, you can [start a coverage conversation](/get-coverage) in a few minutes.
...
- [CareScout/Genworth — CareScout Releases 2025 Cost of Care Survey Results (2026)](https://investor.genworth.com/news-events/press-releases/detail/1054/carescout-releases-2025-cost-of-care-survey-results)
- [CareScout — Cost of Care Survey 2025: Median Cost Data Tables (2026)](https://assets.carescout.com/x/8fcb50422f/282102.pdf)
- [HHS ASPE / Urban Institute — What Is the Lifetime Risk of Needing and Receiving Long-Term Services and Supports? (2019)](https://aspe.hhs.gov/reports/what-lifetime-risk-needing-receiving-long-term-services-supports-0)
...
- [KFF — 10 Things About Long-Term Services and Supports (2024)](https://www.kff.org/medicaid/10-things-about-long-term-services-and-supports-ltss/)
- [AARP — New Report Reveals Crisis Point for America's 63 Million Family Caregivers (2025)](https://www.aarp.org/press/releases/2025-07-24-new-report-reveals-crisis-point-for-americas-63-million-family-caregivers.html)
- [AARP Public Policy Institute — Valuing the Invaluable 2026: Family Caregivers' Contribution Reaches $1 Trillion (2026)](https://www.aarp.org/pri/topics/ltss/family-caregiving/valuing-the-invaluable-2026-update/)
