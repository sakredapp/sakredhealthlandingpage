...
title: "The Price of Getting Sick in America: A $172,500 Retirement Bill and $220 Billion in Medical Debt"
...
```stats
[{"value": 172500, "prefix": "$", "label": "Health costs a single 65-year-old retiring in 2025 may face — double the 2002 estimate", "source": "Fidelity Investments, 2025"}, {"value": 220, "prefix": "$", "suffix": "B", "label": "Total medical debt owed by people in the US", "source": "Peterson-KFF, 2024"}, {"value": 41, "suffix": "%", "label": "US adults carrying some form of health care debt", "source": "KFF Health Care Debt Survey, 2022"}, {"value": 12, "suffix": "%", "label": "Medical GoFundMe campaigns that met their goal, of 437,596 studied", "source": "American Journal of Public Health, 2022"}]
```
...
1. **Close the coverage gap first.** Uninsured and part-year-insured adults carry medical debt at nearly double the rate of the continuously insured (14% vs. 8%, per Peterson-KFF). If you're between jobs, self-employed, or retiring before 65, continuous [health coverage](/products/health-insurance) is the single most effective medical-debt prevention tool the data identifies.
2. **Fund the HSA — and invest it — if you're eligible.** Treat it as a retirement health account, not a checking account for copays. The 55+ catch-up adds $1,000 a year.
3. **Budget retirement health care as a line item, not a contingency.** A realistic single-person planning figure is Fidelity's $172,500 — roughly $6,500 a year in Medicare-era out-of-pocket costs at current KFF averages, rising with medical inflation.
4. **Build guaranteed income to cover fixed health costs.** Since Part B and D premiums plus cost-sharing already absorb about a quarter of the average Social Security check (KFF, 2025), pairing Social Security with a [retirement annuity](/products/retirement-annuities) can ensure premiums are always paid from income rather than from drawn-down savings in a bad market year.
5. **Don't count on the backstops.** The bankruptcy and crowdfunding data are clear: the informal safety nets underperform exactly when they're needed.

## The bill arrives either way

Every number in this article describes the same choice framed two ways. Health care in retirement will cost a typical 65-year-old six figures whether or not they planned for it; the difference is whether it's paid from a funded HSA and steady income, or from depleted savings, credit cards, and a fundraising page with a 12% success rate. The planning window matters most in the 10–15 years before Medicare — the same 50–64 age band where medical debt peaks at 10%. If you're in that window, [get a coverage review](/get-coverage) and put real numbers on your own version of the $172,500.
...
- [Fidelity Investments — Fidelity Releases 2025 Retiree Health Care Cost Estimate (2025)](https://newsroom.fidelity.com/pressreleases/fidelity-investments--releases-2025-retiree-health-care-cost-estimate--a-timely-reminder-for-all-gen/s/3c62e988-12e2-4dc8-afb4-f44b06c6d52e)
- [Fidelity Investments — How to Plan for Rising Health Care Costs (2025)](https://www.fidelity.com/viewpoints/personal-finance/plan-for-rising-health-care-costs)
- [Peterson-KFF Health System Tracker — The Burden of Medical Debt in the United States (2024)](https://www.healthsystemtracker.org/brief/the-burden-of-medical-debt-in-the-united-states/)
- [KFF — Health Care Debt in the U.S.: The Broad Consequences of Medical and Dental Bills (2022)](https://www.kff.org/health-costs/kff-health-care-debt-survey/)
- [KFF — Key Facts About Health Care Affordability for People with Medicare (2025)](https://www.kff.org/medicare/key-facts-about-health-care-affordability-for-people-with-medicare/)
- [Health Affairs / CMS Office of the Actuary — National Health Care Spending Increased 7.2 Percent in 2024 (2026)](https://www.healthaffairs.org/doi/10.1377/hlthaff.2025.01683)
- [Health Affairs / CMS Office of the Actuary — National Health Expenditure Projections, 2024–33 (2025)](https://www.healthaffairs.org/doi/10.1377/hlthaff.2025.00545)
- [American Journal of Public Health — Medical Bankruptcy: Still Common Despite the Affordable Care Act (2019)](https://ajph.aphapublications.org/doi/10.2105/AJPH.2018.304901)
- [American Journal of Public Health — Medical Crowdfunding and Disparities in Health Care Access in the United States, 2016–2020 (2022)](https://ajph.aphapublications.org/doi/10.2105/AJPH.2021.306617)
- [Devenir — 2025 Year-End Devenir HSA Research Report (2026)](https://www.devenir.com/research/2025-year-end-devenir-hsa-research-report/)
