...
**Order doesn't matter, but 1–8 are the ones worth doing first** — those posts
are current, getting traffic, and are the ones with no artwork at all.

---

# PRIORITY — do these first

## Image 1 of 20 — Big Food: sugar disclosure
...
has no label of any kind. The visual point is that one item carries information
and the other carries none. Even, cool daylight from one side, soft shadows,
shallow depth of field. Muted palette: cream, stone grey, warm oak, one muted
gold accent. Matte surfaces, no glossy highlights. Generous negative space.
No text, no lettering, no logos, no watermarks, no brand marks, no faces.
```

## Image 2 of 20 — Ultra-processed food and appetite
...
packaged snack foods in generic unbranded forms: plain crackers, puffed shapes,
a bar in blank unmarked wrapping. The two portions are deliberately similar in
bulk. Clinical, neutral, documentary lighting — even and flat, like a study
photograph rather than a food advertisement. Muted cream and stone palette.
No text, no lettering, no logos, no watermarks, no brand marks, no faces.
```

## Image 3 of 20 — Nutrition and intelligence
...
across the surface, dust motes visible in the beam. The mood is quiet and
archival — a 1950s public-health records room, slightly nostalgic, a little
melancholy. Shallow depth of field, soft shadows, generous negative space.
No readable text or numbers anywhere, no lettering, no logos, no watermarks,
no faces.
```

## Image 4 of 20 — Sugary drinks and the liver
...
deliberate, like a laboratory sample rather than a spill. Cool even daylight
from one side, soft shadows, shallow depth of field. Muted palette of cream,
stone grey and pale glass, one muted gold accent. Clinical and restrained rather
than appetizing. Generous negative space. No text, no lettering, no logos, no
watermarks, no brand marks, no bottles, no cans, no faces.
```

## Image 5 of 20 — Packaging chemicals
...
a kitchen. Restrained muted palette: stone grey, brushed metal, cream. Matte
surfaces, shallow depth of field, generous negative space. Calm and factual in
mood, not alarming or ominous. No text, no lettering, no logos, no watermarks,
no brand marks, no faces.
```

## Image 6 of 20 — Seed oils
...
of field. Muted palette: cream, stone grey, warm gold. The mood is neutral and
appraising — neither appetizing nor sinister. Generous negative space. No text,
no lettering, no logos, no watermarks, no brand marks, no faces.
```

## Image 7 of 20 — Pumpkin spice latte
...
deliberately larger than looks comfortable next to the cup. The sugar is the
subject; the drink is the setting. Warm autumn light, long soft shadows, shallow
depth of field. Muted cream, stone and amber palette. Absolutely no branded cup,
no paper sleeve, no plastic lid, no green logo, no text, no lettering, no
watermarks, no faces.
```

## Image 8 of 20 — Trendy chain drinks
...
Neutral catalogue composition, soft diffused daylight, gentle shadows. Muted
cream and stone palette. Plain glass only — no branded cups, no sleeves, no
lids, no straws, no logos, no text, no lettering, no watermarks, no faces.
```
...
separate piles of ground cinnamon in visibly different shades: one lighter and
tan, one darker and redder. Also in frame, a few quills of Ceylon cinnamon bark,
which look like thin fragile cigars made of many paper-like layers rolled
together — distinctly different from a single thick hard curl. Warm kitchen
window light, flour dust on the wooden surface. No text, no lettering, no logos,
no watermarks, no faces.
```

## Image 10 of 20 — Pumpkin bread
...
plain pumpkin purée with its blank unlabeled side facing the camera. Warm morning
window light, a rumpled linen cloth, rustic and homemade rather than
bakery-glossy. No frosting, no streusel topping, no icing. No text, no lettering,
no logos, no watermarks, no faces.
```

## Image 11 of 20 — Sweet potato casserole
...
table light, a linen napkin, a few loose pecan halves scattered on the table.
CRITICAL: there must be absolutely no marshmallows anywhere in the image — no
white puffs, no browned marshmallow topping, nothing marshmallow-like. The
topping is pecans and oats only. No text, no lettering, no logos, no watermarks,
no faces.
```
...
These share a quieter, more abstract style than the food images.

## Image 12 of 20 — Sleep
...
blue palette. Soft natural light, generous negative space, shallow depth of
field. No text, no lettering, no logos, no watermarks, no faces.
```

## Image 13 of 20 — Gut health
...
Generous negative space, shallow depth of field. Human presence implied but no
person visible. No text, no lettering, no labels, no logos, no watermarks, no
faces.
```

## Image 14 of 20 — Desk movement
...
presence implied but no person visible. No text, no lettering, no logos, no
watermarks, no faces.
```

## Image 15 of 20 — Screen fatigue
...
negative space. Human presence implied but no person visible. No text, no
lettering, no logos, no watermarks, no faces.
```

## Image 16 of 20 — Journaling and breathwork
...
depth of field. The pages must be entirely blank — no handwriting, no printed
lines of text. Human presence implied but no person visible. No text, no
lettering, no logos, no watermarks, no faces.
```

## Image 17 of 20 — Burnout prevention
...
depth of field. Human presence implied but no person visible. No text, no
lettering, no logos, no watermarks, no faces.
```

## Image 18 of 20 — Workforce wellness
...
Completely empty of people. No text, no lettering, no logos, no watermarks, no
faces.
```

## Image 19 of 20 — Habit tracking
...
light across the desk. Muted stone and sage palette, shallow depth of field,
generous negative space. No text, no lettering, no logos, no watermarks, no
faces.
```

## Image 20 of 20 — Habit loops
...
Muted stone and sage palette, generous negative space. No text, no lettering, no
logos, no watermarks, no faces.
```

---

# THREE MORE, IF YOU WANT THEM

Lower priority — these posts already work without artwork.
...
highlights. Generous negative space. No text, no lettering, no logos, no
watermarks, no labels, no faces.
```

## Extra B — Nature and wellness
...
light, muted stone and sage palette, generous negative space. No text, no
lettering, no logos, no watermarks, no brand marks, no faces.
```
...
**Why every prompt bans text and logos.** Generated lettering is almost always
subtly malformed and is the clearest visual tell that an image was
machine-made. And several of these posts name Starbucks, Dunkin', Cinnabon and
Swiss Miss while carrying a non-affiliation disclaimer — depicting their
branding would contradict it.

**Two prompts have hard content constraints** that exist because the image would
otherwise contradict the article it sits on. Image 11 must contain no
marshmallows, because that post argues against the marshmallow version. Image 9
needs Ceylon bark to look different from cassia, because the difference between
