            ...
            {submitted ? (
              <div className="text-center py-12">
                ...
                <p className="text-sm text-[#2C2C2C]/50">
                  Keep an eye on your phone — we'll text you within minutes to confirm your details and help schedule a call.
                </p>
              </div>
            ) : (
                ...
                <div className="border-t border-[#E8E4DC] pt-6">
                  <label className="flex items-start gap-3 cursor-pointer group">
                    ...
                    <span className="text-xs text-[#2C2C2C]/60 leading-relaxed">
                      By checking this box and clicking submit, I give Sakred Health and a licensed insurance
                      agent acting on its behalf my prior express written consent to contact me about insurance
                      products and services at the phone number and email address I provided — including by
                      live telephone call, SMS text message, automatic telephone dialing system, and artificial
                      or prerecorded voice — even if my number is listed on a federal, state, or company Do Not
                      Call registry. Consent is not a condition of any purchase. Message frequency varies and
                      message &amp; data rates may apply. I can revoke consent at any time, including by
                      replying STOP to any text or HELP for assistance. I have read the{" "}
