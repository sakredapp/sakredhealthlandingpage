...
const clientTypes: ClientType[] = [
  {
    ...
    bullets: [
      ...
      "Need clear, plain-language access to coverage details and policy search",
      "Benefit from a dedicated agent who understands individual plans",
      "Wellness routines and habit tracking to support high-demand lifestyles",
    ],
  },
  {
    ...
    bullets: [
      "Managing coverage for multiple family members in one dashboard",
      "Quick access to copays, deductibles, and documents for each person",
      "Estate planning and life policy access for long-term family security",
      "Foundational wellness routines the whole family can follow",
    ],
  },
  {
    title: "Pre-Retirees & Retirees",
    description: "Ages 50+ — planning for Medicare transitions, retirement income, and legacy",
    bullets: [
      "Retirement annuity details, payout schedules, and carrier info in one place",
      "Estate planning resources and secure document storage",
      "Chronic condition life policies managed alongside health coverage",
  ...
  },
  {
    ...
    bullets: [
      "Chronic condition life policies tailored to your health profile",
      "Policy search to decode complex coverage terms for treatments and specialists",
      "Dedicated agent support for claims, referrals, and pre-authorizations",
      "Wellness routines that complement your care plan",
    ],
  },
  {
    title: "Young Adults Aging Off Parents' Plans",
    description: "Ages 26-30 — just lost coverage and don't know where to start",
    bullets: [
